...
public class C03BitArith {
	...
	public static void main(String[] args) {
		...
		System.out.println("AND 비트 연산 결과 : " + num3);	//& : 둘 다 1일때
		System.out.println("OR 비트 연산 결과 : " + num4);	//| : 둘중 하나가 1일때
		System.out.println("XOR 비트 연산 결과 : " + num5);	//^ : 두개가 서로 다를때
		System.out.println("NOT 비트 연산 결과 : " + num6); //~ : 반전
	}
